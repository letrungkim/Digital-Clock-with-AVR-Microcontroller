...
#include <stdio.h>                                                                                      
#include <avr/io.h>
#define bitRead(v, bit) (((v) >> (bit)) & 0x01)
#define bitSet(v, bit) ((v) |= (1UL << (bit)))
#define bitClear(v, bit) ((v) &= ~(1UL << (bit)))
#define bitWrite(v, bit, bitvalue) (bitvalue ? bitSet(v, bit) : bitClear(v, bit))                                                                                                         //|
